...
List<Map<String, dynamic>> exercisesArr = [
  ...
  },
  {
    ...
    "set": [
      ...
      {
        "image": "assets/img/plank to jump.jpg",
      ...
      {
        "image": "assets/img/russian twist.jpg",
      ...
      {
        "image": "assets/img/dumbell rows.jpg",
        "title": "Dumbbell Rows",
        "value": "20x",
...
List<Map<String, dynamic>> lowerBodyWorkoutArr = [
  {
    ...
    "set": [
      {
        "image": "assets/img/body weight squats.jpg",
      ...
      {
        "image": "assets/img/forward lunges.jpg",
      ...
      {
        "image": "assets/img/romanian dead lifts.jpg",
      ...
      {
        "image": "assets/img/calf raises.jpg",
        "title": "Calf Raises",
        "value": "20x",
        "description":
  ...
  },
  {
    ...
    "set": [
      {
        "image": "assets/img/glute bridges.jpg",
        "title": "Glute Bridges",
        "value": "15x",
        "description":
      ...
      {
        "image": "assets/img/lateral leg rises.jpg",
...
List<Map<String, dynamic>> abWorkoutArr = [
  {
    ...
    "set": [
      ...
      {
        "image": "assets/img/bycycle crunches.jpg",
      ...
      {
        "image": "assets/img/Leg raises.jpg",
        "title": "Leg Raises",
        "value": "15x",
        "description":
  ...
  },
  {
    ...
    "set": [
      {
        "image": "assets/img/Mountain climbers.jpg",
      ...
      {
        "image": "assets/img/Lying leg twist.jpg",
      ...
      {
        "image": "assets/img/Plank jack.jpg",
        "title": "Plank Jacks",
        "value": "20x",
        "description":
